...
@door.route('/range', methods=["GET"])
@jwt_required()
def get_door_by_range():
    ...
    last_value = influx_query.get_last_value_for_SensorData_by_range([0, start_date_obj.isoformat()], gateway_id, [target_device], "Contact")
    query = f"""
